        ...
        {drawerOpen && (
          <>
            ...
            >
              ...
              >
                {/* Instagram */}
                <a href="https://www.instagram.com/craigshelly/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: 'rgba(255,255,255,0.35)', transition: 'color 0.2s' }}>
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/CraigShellyBH/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: 'rgba(255,255,255,0.35)', transition: 'color 0.2s' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
